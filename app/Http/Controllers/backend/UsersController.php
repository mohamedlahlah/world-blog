...
class UsersController extends BackendController
{
    ...
    public function index()
    {
        ...
        return view("backendblog.users.index", compact('users', 'usersCount'));
    }
    ...
    {
        $user = new User();
        return view("backendblog.users.create", compact('user'));
    }
    ...
    {    $name = $request->all();
        ...
        $name['slug']=str_replace(" " ,"-",$name['name'],$counter);

        $name['password'] = bcrypt($name['password']);
    ...
    public function edit($id)
    {
        ...
        return view("backendblog.users.edit", compact('user'));
    }
    ...
    public function destroy(Requests\UserDestroyRequest $request, $id)
    {
        ...
        elseif ($deleteOption == "attribute") {
            $user->posts()->update(['auther_id' => $selectedUser]);
        }
    ...
    public function confirm(Requests\UserDestroyRequest $request, $id)
    {
        ...
        return view("backendblog.users.confirm", compact('user', 'users'));
    }
}
