    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                @else
                <button title="Restore" onclick="return fales" class="btn btn-xs btn-disabled">
                    <i class="fa fa-refresh"></i>
                </button>
                @endif
                {!! Form::close() !!}
               ...
               @if(check_user_permissions($request,Blog@forceDestroy,$post->id))
                ...
                @else
                <button title="Delete Permanent" onclick="return false" type="submit" class="btn btn-xs btn-disabled">
                    <i class="fa fa-times"></i>
                </button>
                @endif
                {!! Form::close() !!}
